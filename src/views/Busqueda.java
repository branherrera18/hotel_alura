...
public class Busqueda extends JFrame {
	...
	private void cargarTablaReservas() {
		...
		reservas.forEach(reserva -> modelo.addRow(new Object[] { reserva.getId_reserva(), reserva.getFecha_entrada(),
	...
	private void cargarTablaHuespedes() {
		...
		huespedes.forEach(huesped -> modeloH.addRow(new Object[] { huesped.getId_huesped(), huesped.getNombre(),
	...
	private void modificar() {
		...
		if (noTieneFilaElegidaHuespedes()) {
			Optional.ofNullable(modelo.getValueAt(tbReservas.getSelectedRow(), tbReservas.getSelectedColumn()))
					.ifPresentOrElse(fila -> {
						Integer id_reserva = Integer.valueOf(modelo.getValueAt(tbReservas.getSelectedRow(), 0).toString());
						...
						reservaController.modificar(fecha_entrada, fecha_salida, valor, forma_pago, id_reserva);
		...
		if (noTieneFilaElegidaReservas()) {
			Optional.ofNullable(modeloH.getValueAt(tbHuespedes.getSelectedRow(), tbHuespedes.getSelectedColumn()))
					.ifPresentOrElse(fila -> {
						Integer id_huesped = Integer.valueOf(modeloH.getValueAt(tbHuespedes.getSelectedRow(), 0).toString());
						...
						int id_reserva = Integer.valueOf(modeloH.getValueAt(tbHuespedes.getSelectedRow(), 6).toString());
						huespedController.modificarHuesped(nombre, apellido, fecha_nacimiento, nacionalidad, telefono,
