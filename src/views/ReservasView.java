		...
		btnsiguiente.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				if (ReservasView.txtFechaE.getDate() != null && ReservasView.txtFechaS.getDate() != null) {	
					...
					reserva_id = reserva.getId_reserva();
					limpiar();
					RegistroHuesped registro = new RegistroHuesped(reserva_id); //revisar
	    ...
	    private void calcularEstadia(JDateChooser txtFechaE, JDateChooser txtFechaS) {
	    	if(txtFechaS.getDate() !=null && txtFechaE.getDate() != null) {
	    		if(txtFechaS.getDate().after(txtFechaE.getDate())) {
		    		...
		    		int valor_por_noche = 350;
		    		long milliS_toFechaS = txtFechaS.getDate().getTime();
		    		long milliS_toFechaE = txtFechaE.getDate().getTime();
		    		long miliS_diferencia = milliS_toFechaS - milliS_toFechaE;
		    		int dias_diferencia = (int) miliS_diferencia / 86400000;
		    		int valor_total = dias_diferencia * valor_por_noche;
		    		String valor_totals = String.valueOf(valor_total);
		    		txtValor.setText(valor_totals);
	    	}else {
	    		txtValor.setText("");
	    		JOptionPane.showMessageDialog(null, "No puedes salir antes de la fecha de entrada!");
	    	}
	    }
