	...
	public RegistroHuesped(int reserva_id) {
		...
		btnguardar.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				int reserva_idINT = Integer.parseInt(txtNreserva.getText());
				
				var huesped = new Huesped(txtNombre.getText(), txtApellido.getText(), Date.valueOf(fecha_nacimiento),
						txtNacionalidad.getSelectedItem().toString(), txtTelefono.getText(), reserva_idINT);
				HuespedController huespedController = new HuespedController();
				huespedController.guardar(huesped, reserva_idINT);
				RegistroHuesped registro = new RegistroHuesped(reserva_id);
